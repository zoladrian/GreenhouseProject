...
- Zakładka **Sensory** pokazuje zarejestrowane czujniki; **Przypisanie do nawy** powoduje, że wilgotność i wykresy pojawiają się na **Dashboardzie** i w szczegółach nawy. Wykres wilgotności: pionowe linie epizodów (podlanie vs heurystyka deszczu) — [**ANALYTICS_WATERING.md**](ANALYTICS_WATERING.md).
